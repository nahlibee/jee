...
<body class="flex items-center justify-center h-screen" style="background-image: url('assets/images/bg-01.jpg'); background-size: cover;">
    ...
    <h1 class="text-3xl font-extrabold text-gray-800 mb-6">Ajouter Professeur</h1>
</div>
        <form action="professeurServlet" method="post" class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
             ...
             <button type="submit" class="mx-auto block w-full bg-gradient-to-r from-blue-500 to-green-500 text-white p-4 rounded-md hover:opacity-90 focus:outline-none focus:ring focus:border-indigo-500">Ajouter</button>
        </form>
    </div>
