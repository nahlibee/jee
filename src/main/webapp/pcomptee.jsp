...
<body class="app">   	
    <header class="app-header fixed-top">	   	            
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link active " href="pcomptee.jsp">
								<span class="nav-icon">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="offrespServlet?action=list">
						        <span class="nav-icon">
 ...
 <div class="app-wrapper">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-6">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start w-100">
...
%>
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data">  <%= professeur.getEmail() %></div>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>CIN</strong></div>
									        <div class="item-data">
										        <%= professeur.getCin() %> 
									        </div>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>NumPRP</strong></div>
									        <div class="item-data">
										        ${password}
									        </div>
									    </div><!--//col-->
            ...
            <a class="btn app-btn-secondary" style="background: linear-gradient(to right, #1E90FF,#1E90FF); color: white;" href="#">Edit Profile</a>
        </div><!--//app-card-footer-->
    </div><!--//app-card-->
</div><!--//col-->
